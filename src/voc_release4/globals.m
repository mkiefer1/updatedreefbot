...
[status, root_dir] = system('rospack find cascade_parts_detector');
if (status ~= 0)
    error('Could not find the cascade_parts_detector directory. Check your ROS path');
end  
cscdir = [root_dir(1:end-1) '/src/voc_release4/star-cascade/data/'];
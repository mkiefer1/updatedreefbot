...
test('/data/mdesnoye/pedestrian/eth/hima/set01/frames/I00141.png', model)
fprintf('\nPress any key to continue with demo'); pause; fprintf('...ok\n\n');

test('/data/mdesnoye/pedestrian/eth/hima/set00/frames/I00141.png', model)
fprintf('\nPress any key to continue with demo'); pause; fprintf('...ok\n\n');

test('/data/mdesnoye/pedestrian/eth/hima/set02/frames/I00015.png', model)
fprintf('\nPress any key to continue with demo'); pause; fprintf('...ok\n\n');
